    ...
    <div className="bg-gradient-to-r from-green-50 to-green-100 min-h-screen py-12 px-6 sm:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-3xl font-bold mb-4 text-green-800">Languages for DSA</h2>
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-3xl font-bold mb-4 text-green-800">Core DSA Topics</h2>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <h2 className="text-3xl font-bold mb-6 text-green-800">Current DSA Challenge</h2>
          <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="text-2xl font-bold text-green-900 mb-2">Dynamic Programming Challenge</h3>
            <p className="text-gray-700 mb-4">
              Solve 5 advanced problems on Dynamic Programming to enhance your problem-solving skills.
            </p>
            <div className="flex items-center text-green-600 mb-2">
              <FiClock className="mr-2" />
              <span className="font-medium">Time Left: 3h 20m</span>
            </div>
            <button className="mt-4 px-6 py-3 bg-green-600 text-white rounded-full shadow-md hover:bg-green-700 transition">
              Start Challenge
            </button>
          </div>
        </motion.div>
